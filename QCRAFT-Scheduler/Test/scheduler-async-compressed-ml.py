...
async def main():
    """
    Función principal que envía todos los circuitos a la política Compressed_ML_Knapsack
    """
    print("=" * 80)
    ...
    data_template = {
        ...
        "shots": 10000,
        "provider": ['ibm'],
        "policy": "Compressed_ML_Knapsack"  # ← Política con compresión individual + ML
    }
