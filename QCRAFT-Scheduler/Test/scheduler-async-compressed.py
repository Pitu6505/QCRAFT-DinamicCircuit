"""
Test asíncrono para la política Topology_Compressed
Envía múltiples circuitos simultáneamente al scheduler con compresión de topología
"""
import aiohttp
import asyncio
...
# Conjunto de circuitos de prueba
urls = {
    ...
    "arbol-1": "https://raw.githubusercontent.com/Pitu6505/QCRAFT-DinamicCircuit/refs/heads/Develop/QCRAFT-Scheduler/Test/CircuitosComprimibles/Arbol.py",
    "domino-1": "https://raw.githubusercontent.com/Pitu6505/QCRAFT-DinamicCircuit/refs/heads/Develop/QCRAFT-Scheduler/Test/CircuitosComprimibles/Domino.py",
    "router-1": "https://raw.githubusercontent.com/Pitu6505/QCRAFT-DinamicCircuit/refs/heads/Develop/QCRAFT-Scheduler/Test/CircuitosComprimibles/Router.py",
    "ghz-5": "https://raw.githubusercontent.com/Pitu6505/QCRAFT-DinamicCircuit/refs/heads/Develop/QCRAFT-Scheduler/Test/CircuitosComprimibles/ghz_alg_5_original.py",
    "ghz-6": "https://raw.githubusercontent.com/Pitu6505/QCRAFT-DinamicCircuit/refs/heads/Develop/QCRAFT-Scheduler/Test/CircuitosComprimibles/ghz_alg_6_original.py",
    "ghz-8": "https://raw.githubusercontent.com/Pitu6505/QCRAFT-DinamicCircuit/refs/heads/Develop/QCRAFT-Scheduler/Test/CircuitosComprimibles/ghz_alg_8_original.py",
    "indep-4": "https://raw.githubusercontent.com/Pitu6505/QCRAFT-DinamicCircuit/refs/heads/Develop/QCRAFT-Scheduler/Test/CircuitosComprimibles/ghz_indep_4_original.py",
    "indep-5": "https://raw.githubusercontent.com/Pitu6505/QCRAFT-DinamicCircuit/refs/heads/Develop/QCRAFT-Scheduler/Test/CircuitosComprimibles/ghz_indep_5_original.py",
    "indep-6": "https://raw.githubusercontent.com/Pitu6505/QCRAFT-DinamicCircuit/refs/heads/Develop/QCRAFT-Scheduler/Test/CircuitosComprimibles/ghz_indep_6_original.py",
    "indep-8": "https://raw.githubusercontent.com/Pitu6505/QCRAFT-DinamicCircuit/refs/heads/Develop/QCRAFT-Scheduler/Test/CircuitosComprimibles/ghz_indep_8_original.py",
    "synthetic_cascade_8q": "https://raw.githubusercontent.com/Pitu6505/QCRAFT-DinamicCircuit/refs/heads/Develop/QCRAFT-Scheduler/Test/CircuitosComprimibles/synthetic_cascade_8q.py",
    "synthetic_qpe_9q": "https://raw.githubusercontent.com/Pitu6505/QCRAFT-DinamicCircuit/refs/heads/Develop/QCRAFT-Scheduler/Test/CircuitosComprimibles/synthetic_qpe_9q.py",
    "synthetic_zigzag_7q": "https://raw.githubusercontent.com/Pitu6505/QCRAFT-DinamicCircuit/refs/heads/Develop/QCRAFT-Scheduler/Test/CircuitosComprimibles/synthetic_zigzag_7q.py",
...
async def post_request(session, url, data):
    """Envía una petición POST asíncrona"""
    try:
        async with session.post(url, json=data) as response:
            text = await response.text()
            return f"✓ {data.get('url', 'Unknown')[:80]}: {text[:100]}"
    except Exception as e:
        return f"✗ Error en {data.get('url', 'Unknown')[:50]}: {str(e)[:100]}"

async def main():
    """
    Función principal que envía todos los circuitos a la política Topology_Compressed
    """
    print("=" * 80)
    print("🗜️  TEST ASÍNCRONO: Política Topology_Compressed")
    print("=" * 80)
    print(f"\n📊 Configuración:")
    print(f"   - Total de circuitos: {len(urls)}")
    print(f"   - Policy: Topology_Compressed")
    print(f"   - Provider: IBM")
    print(f"   - Shots: 10000")
    print(f"   - URL del scheduler: {url}")
    print("\n🚀 Enviando circuitos al scheduler...\n")
    
    # Plantilla de datos para cada circuito
    data_template = {
        "url": "",
        "shots": 10000,
        "provider": ['ibm'],
        "policy": "Topology_Compressed"  # ← Nueva política con compresión
    }
    
    async with aiohttp.ClientSession() as session:
        tasks = []
        
        # Crear una tarea asíncrona por cada circuito
        ...
        print(f"⏳ Esperando respuestas de {len(tasks)} circuitos...\n")
        ...
        for i, response in enumerate(responses, 1):
            print(f"{i:3d}. {response}")
        
        # Estadísticas
        successful = sum(1 for r in responses if r.startswith("✓"))
        failed = sum(1 for r in responses if r.startswith("✗"))
        
        print("\n" + "=" * 80)
        print(f"📈 ESTADÍSTICAS:")
        print(f"   ✅ Exitosos: {successful}/{len(responses)}")
        print(f"   ❌ Fallidos: {failed}/{len(responses)}")
        print(f"   📊 Tasa de éxito: {successful/len(responses)*100:.1f}%")
        print("=" * 80)
        
        print("\n💡 Tip: Revisa los logs del scheduler para ver las métricas de compresión")
        print("   📄 Archivo de métricas: SalidaTopologyCompressed.txt\n")
